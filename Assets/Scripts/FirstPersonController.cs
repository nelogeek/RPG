    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(playerCamera.transform.position, playerCamera.transform.forward, out hit, distance))
        {
            ...
            if (hit.transform.tag == "Enemy")
            {
                ...
                {
                    var health = hit.collider.gameObject.GetComponent<EnemyController>();
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        #region Damage setup
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Damage Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        EditorGUILayout.Space();
        fpc.damage = EditorGUILayout.Slider(new GUIContent("Damage"), fpc.damage, 1, 100);
        fpc.distance = EditorGUILayout.Slider(new GUIContent("Distance damage"), fpc.distance, 1, 100);
        #endregion

        #region HUD Health
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("HUD Health", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        EditorGUILayout.Space();
        fpc.playerHelthText = (TextMeshProUGUI)EditorGUILayout.ObjectField(new GUIContent("Player helth text"), fpc.playerHelthText, typeof(TextMeshProUGUI), true);
        fpc.redOverlay = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Red overlay"), fpc.redOverlay, typeof(GameObject), true);
        fpc.End = (GameObject)EditorGUILayout.ObjectField(new GUIContent("End screen"), fpc.End, typeof(GameObject), true);
        #endregion
